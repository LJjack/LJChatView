...
+ (BOOL)convertAudioFileToAMR:(GJCFAudioModel *)audioFile
{
    ...
    /* 开始转换 */
    int result = 0;//[VoiceConverter wavToAmr:audioFile.localStorePath amrSavePath:audioFile.tempEncodeFilePath];
...
+ (BOOL)convertAudioFileToWAV:(GJCFAudioModel *)audioFile
{
    ...
    /* 开始转换 */
    int result = 0;//[VoiceConverter amrToWav:audioFile.tempEncodeFilePath wavSavePath:audioFile.localStorePath];
