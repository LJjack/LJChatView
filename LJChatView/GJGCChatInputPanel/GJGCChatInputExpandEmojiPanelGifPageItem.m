...
- (void)initSubViewsWithEmojiNames:(NSArray *)emojiArray
{
    ...
    CGFloat emojiWidth = [UIScreen mainScreen].bounds.size.width/4;
...
- (void)tapOnEmojiButton:(UITapGestureRecognizer *)tapR
{
    ...
    NSDictionary *relationDict = [NSDictionary dictionaryWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"gifCode" ofType:@"plist"]];
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:formateNoti object:gifLocalId];
