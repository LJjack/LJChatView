...
- (instancetype)initWithPosition:(GJGCChatInputGifFloatViewPosition)position withGifName:(NSString *)gifName
{
    if (self = [super init]) {
        ...
        NSString *gifFilePath = [[NSBundle mainBundle] pathForResource:gifName ofType:nil];
...
//    CGSize imageSize = originImage.size;
    ...
    return [originImage resizableImageWithCapInsets:UIEdgeInsetsMake(top, left, bottom, right)];
}
