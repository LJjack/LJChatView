...
- (instancetype)initWithSelectedIcon:(UIImage *)selectedIcon withNormalIcon:(UIImage *)normalIcon
{
    if (self = [super init]) {
        ...
        [self.normalStateButton.backButton setBackgroundImage:[UIImage imageNamed:@"聊天键盘切换-btn-圆"] forState:UIControlStateNormal];
        [self.normalStateButton.backButton setBackgroundImage:[UIImage imageNamed:@"聊天键盘切换-btn-圆-点击"] forState:UIControlStateHighlighted];
