                               ...
                               withLayout:(JSQMessagesCollectionViewFlowLayout *)layout
{
    ...
    if ([messageData isMediaMessage]) {
        ...
        CGRect stringRect =[[messageData attributedText] boundingRectWithSize:CGSizeMake(maximumTextWidth, CGFLOAT_MAX) options:(NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading) context:nil];
