...
- (void)initSubViews
{
    ...
    [topLine setBackgroundColor:[UIColor colorWithRed:217/255.0 green:217/255.0 blue:217/255.0 alpha:1.0]];
    [self addSubview:topLine];
    
    self.bottomLine = [[UIView alloc] initWithFrame:CGRectMake(0, self.barHeight - 0.5, screenWidth, 0.5)];
    [self.bottomLine setBackgroundColor:[UIColor colorWithRed:217/255.0 green:217/255.0 blue:217/255.0 alpha:1.0]];
    ...
    UIImage *recordIcon = [UIImage imageNamed:@"聊天-icon-语音及切换键盘-灰"];
    UIImage *keybordIcon = [UIImage imageNamed:@"聊天-icon-文字键盘"];
    self.recordAudioBarItem = [[GJGCChatInputBarItem alloc]initWithSelectedIcon:keybordIcon withNormalIcon:recordIcon];
    
    if (CGSizeEqualToSize((CGSize){414,736}, [UIScreen mainScreen].bounds.size)) {
    ...
    /* 展开面板按钮 */
    UIImage *extendIcon = [UIImage imageNamed:@"聊天-icon-选择照片帖子"];
    ...
    self.openPanelBarItem.gjcf_right = screenWidth - self.itemToBarMargin;
    ...
    /* 输入文本 */
    self.inputTextView = [[GJGCChatInputTextView alloc]initWithFrame:CGRectMake(self.recordAudioBarItem.gjcf_right + self.itemMargin ,0,screenWidth - 35 * 3 - 2*self.itemToBarMargin - self.itemMargin * 3 , 32)];
    [self addSubview:self.inputTextView];
    [self.inputTextView setRecordAudioBackgroundImage:[UIImage imageNamed:@"输入框-灰色"]];
    [self.inputTextView setInputTextBackgroundImage:[UIImage imageNamed:@"输入框-白色"]];
    ...
    /* 表情按钮 */
    UIImage *emojiIcon = [UIImage imageNamed:@"聊天-icon-选择表情"];
...
- (void)setupForCommentBarStyle
{
    ...
    self.inputTextView.gjcf_width = [UIScreen mainScreen].bounds.size.width - 2*self.itemToBarMargin - self.itemMargin - self.emojiBarItem.gjcf_width;
