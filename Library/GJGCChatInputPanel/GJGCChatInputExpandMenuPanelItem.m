...
+ (GJGCChatInputExpandMenuPanelItem *)itemWithTitle:(NSString *)title
                                    iconImageNormal:(UIImage *)iconImageNormal
                                     actionType:(GJGCChatInputMenuPanelActionType)actionType
                                         tapBlock:(GJGCChatInputExpandMenuPanelItemDidTapedBlock)tapBlock
{
